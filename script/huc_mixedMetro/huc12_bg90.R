...
huc12_bg90$class90 <- huc12_bg90$class90 %>% as.factor()
...
# write_sf(huc12_bg90, "data/geojson/huc12_bg90.geojson")
st_write(huc12_bg90, dsn = "data/shp/huc12_90", layer = "huc12_bg90", driver = "ESRI Shapefile")
